...
<body>
    ...
    <div id="app">
        @include('admin.partials-admin.aside')
        <div id="main">
            <header class="mb-3">
...
<script>
     // Menyalin konten dari Trix Editor ke input tersembunyi saat formulir disubmit
    document.addEventListener('trix-change', function (event) {
        var editor = event.target;
        var isiInput = document.getElementById('hidden_isi');
        isiInput.value = editor.value;
    });
