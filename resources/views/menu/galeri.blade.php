            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry"
                    ...
                    <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <li data-filter=".filter-app">Training</li>
                        <li data-filter=".filter-product">Event</li>
                        <li data-filter=".filter-friendly">Friendly Match</li>
                        ...
                        @foreach ($galeri as $item)
                            <div
                                class="col-lg-4 col-md-6 portfolio-item
                                 {{ $item->kategori == 'Training'
                                     ? 'filter-app'
                                     : ($item->kategori == 'Event'
                                         ? 'filter-product'
                                         : ($item->kategori == 'Friendly-match'
                                             ? 'filter-friendly'
                                             : '')) }}">
                                <img src="{{ asset('storage/' . $item->gambar) }}" class="img-size" alt="">
